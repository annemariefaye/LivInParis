...
namespace Mapbox.Unity.Location
{
    ...
    public class KalmanLatLong
    {
        ...
        {
            get { return _timeStampMilliseconds; }
        }
        ...
        {
            get { return (float)Math.Sqrt(_variance); }
        }
        ...
        public void Process(
            double lat_measurement,
            double lng_measurement,
            float accuracy,
        ...
        )
        {
            ...
            else
            {
                ...
                if (TimeInc_milliseconds > 0)
                {
                    ...
                    _variance +=
                        TimeInc_milliseconds * _qMetresPerSecond * _qMetresPerSecond / 1000;
                    _timeStampMilliseconds = TimeStamp_milliseconds;
