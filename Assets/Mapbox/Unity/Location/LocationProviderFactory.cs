...
namespace Mapbox.Unity.Location
{
    ...
    public class LocationProviderFactory : MonoBehaviour
    {
        ...
        [SerializeField]
        [Tooltip(
            "Custom native Android location provider. If this is not set above provider is used"
        )]
        ...
        {
            Debug.LogFormat(
                "LocationProviderFactory: Injected EDITOR Location Provider - {0}",
                _editorLocationProvider.GetType()
            );
        ...
        void InjectDeviceLocationProvider()
        {
            ...
            {
                Debug.LogFormat(
                    "LocationProviderFactory: Injected native Android DEVICE Location Provider - {0}",
                    _deviceLocationProviderAndroid.GetType()
                );
            ...
            {
                Debug.LogFormat(
                    "LocationProviderFactory: Injected DEVICE Location Provider - {0}",
                    _deviceLocationProviderUnity.GetType()
                );
