    ...
    public class AngleSmoothingLowPass : AngleSmoothingAbstractBase
    {
        ...
        public override double Calculate()
        {
            ...
            for (int i = 1; i < angles.Length; i++)
            {
                ...
                lastSin =
                    _smoothingFactor * Math.Sin(angle * DEG2RAD) + (1 - _smoothingFactor) * lastSin;
                lastCos =
                    _smoothingFactor * Math.Cos(angle * DEG2RAD) + (1 - _smoothingFactor) * lastCos;
