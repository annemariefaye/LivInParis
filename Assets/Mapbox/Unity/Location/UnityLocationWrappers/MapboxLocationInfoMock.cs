namespace Mapbox.Unity.Location
{
    ...
    public struct MapboxLocationInfoMock : IMapboxLocationInfo
    {
        ...
        {
            get { return (float)_location.LatitudeLongitude.x; }
        }

        public float longitude
        {
            get { return (float)_location.LatitudeLongitude.y; }
        }
        ...
        {
            get { return _location.Timestamp; }
        }
    }
}
