namespace Mapbox.Unity.Map
{
    ...
    public static class LocationPrefabCategoryOptions
    {
        ...
        private static Dictionary<
            ...
            List<string>
        > CategoriesToMakiDictionary = new Dictionary<LocationPrefabCategories, List<string>>
        {
            {
            ...
            {
                LocationPrefabCategories.Nightlife,
                new List<string> { "bar", "beer" }
            },
            {
                LocationPrefabCategories.OutdoorsAndRecreation,
                new List<string>
                {
                    "aquarium",
                    "campsite",
            ...
            {
                LocationPrefabCategories.Services,
                new List<string>
                {
                    "bank",
                    "dentist",
            ...
            {
                LocationPrefabCategories.Shops,
                new List<string> { "alcohol-shop", "clothing-store", "shop" }
            },
            {
                LocationPrefabCategories.Transportation,
                new List<string>
                {
                    "bus",
                    "car",
        ...
        private static Dictionary<string, LocationPrefabCategories> MakiToCategoriesDictionary =
            new Dictionary<string, LocationPrefabCategories>();
