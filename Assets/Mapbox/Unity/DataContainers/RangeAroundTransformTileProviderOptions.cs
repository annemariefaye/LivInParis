namespace Mapbox.Unity.Map
{
    ...
    public class RangeAroundTransformTileProviderOptions : ExtentOptions
    {
        ...
        {
            RangeAroundTransformTileProviderOptions options =
                extentOptions as RangeAroundTransformTileProviderOptions;
            if (options != null)
            {
            ...
            {
                Debug.LogError(
                    "ExtentOptions type mismatch : Using "
                        + extentOptions.GetType()
                        + " to set extent of type "
                        + this.GetType()
                );
            }
        }
