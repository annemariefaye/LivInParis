namespace Mapbox.Unity.Map
{
    ...
    public class CustomStyleBundle
    {
        ...
        private void AssignAssets(StyleAssetPathBundle styleAssetPathBundle)
        {
            Material topMaterial =
                Resources.Load(styleAssetPathBundle.topMaterialPath, typeof(Material)) as Material;
            Material sideMaterial =
                Resources.Load(styleAssetPathBundle.sideMaterialPath, typeof(Material)) as Material;

            AtlasInfo atlas =
                Resources.Load(styleAssetPathBundle.atlasPath, typeof(AtlasInfo)) as AtlasInfo;
            ScriptablePalette palette =
                Resources.Load(styleAssetPathBundle.palettePath, typeof(ScriptablePalette))
                as ScriptablePalette;
        ...
        {
            StyleAssetPathBundle styleAssetPathBundle = new StyleAssetPathBundle(
                "Default",
                Constants.Path.MAP_FEATURE_STYLES_DEFAULT_STYLE_ASSETS
            );
    ...
    public class GeometryMaterialOptions : ModifierProperties, ISubLayerTexturing
    {
        ...
        {
            get { return typeof(MaterialModifier); }
        }
        ...
        public void SetDefaultMaterialOptions()
        {
            ...
            {
                texturingType =
                    (style != StyleTypes.Custom && style == StyleTypes.Simple)
    ...
    public class UVModifierOptions : ModifierProperties
    {
        public override Type ModifierType
        {
            get { return typeof(PolygonMeshModifier); }
        }
        public StyleTypes style;
        public UvMapType texturingType = UvMapType.Tiled;
        public AtlasInfo atlasInfo;
