...
namespace Mapbox.Unity.Map
{
    ...
    public class AbstractMap : MonoBehaviour, IMap
    {
        ...
        [SerializeField]
        protected TerrainLayer _terrain = new TerrainLayer();

        [SerializeField]
        protected VectorLayer _vectorData = new VectorLayer();
        ...
        [SerializeField]
        protected EditorPreviewOptions _previewOptions = new EditorPreviewOptions();
        ...
        {
            get { return _previewOptions.isPreviewEnabled; }
            set { _previewOptions.isPreviewEnabled = value; }
        }
        ...
        {
            get { return _centerLatitudeLongitude; }
        }

        public Vector2d CenterMercator
        {
            get { return _centerMercator; }
        }
        ...
        {
            get { return (int)Math.Floor(Options.locationOptions.zoom); }
        }
        ...
        public float Zoom
        {
            get { return Options.locationOptions.zoom; }
        }
        ...
        {
            get { return _options.loadingTexture; }
        }
        ...
        {
            get { return _options.tileMaterial; }
        }

        public Type ExtentCalculatorType
        {
            get { return TileProvider.GetType(); }
        }
        ...
        public virtual void UpdateMap(Vector2d latLon, float zoom)
        {
            ...
            xDelta =
                xDelta > 0
                    ? Mathd.Min(xDelta, Mapbox.Utils.Constants.LatitudeMax)
                    : Mathd.Max(xDelta, -Mapbox.Utils.Constants.LatitudeMax);
            zDelta =
                zDelta > 0
                    ? Mathd.Min(zDelta, Mapbox.Utils.Constants.LongitudeMax)
                    : Mathd.Max(zDelta, -Mapbox.Utils.Constants.LongitudeMax);
        ...
        public bool IsAccessTokenValid
        {
            get
            {
                ...
                try
                {
                    ...
                    if (
                        Unity.MapboxAccess.Instance.Configuration == null
        ...
        protected virtual void InitializeMap(MapOptions options)
        {
            ...
            _worldHeightFixed = false;
            _fileSource = MapboxAccess.Instance;
            _centerLatitudeLongitude = Conversions.StringToLatLon(
                options.locationOptions.latitudeLongitude
            );
            ...
            _options.locationOptions.PropertyHasChanged += (
                object sender,
            ...
            _options.extentOptions.PropertyHasChanged += (
                object sender,
                System.EventArgs eventArgs
            ) =>
            {
            ...
            _options.extentOptions.defaultExtents.PropertyHasChanged += (
                object sender,
                System.EventArgs eventArgs
            ) =>
            {
            ...
            _options.placementOptions.PropertyHasChanged += (
                object sender,
                System.EventArgs eventArgs
            ) =>
            {
            ...
            _options.scalingOptions.PropertyHasChanged += (
                object sender,
                System.EventArgs eventArgs
            ) =>
            {
        ...
        private void SetPlacementStrategy()
        {
            switch (_options.placementOptions.placementType)
            {
                case MapPlacementType.AtTileCenter:
                    _options.placementOptions.placementStrategy =
                        new MapPlacementAtTileCenterStrategy();
                    break;
                case MapPlacementType.AtLocationCenter:
                    _options.placementOptions.placementStrategy =
                        new MapPlacementAtLocationCenterStrategy();
                    break;
                default:
                    _options.placementOptions.placementStrategy =
                        new MapPlacementAtTileCenterStrategy();
        ...
        private void SetTileProvider()
        {
            ...
            {
                ITileProviderOptions tileProviderOptions =
        ...
        private void OnVectorDataSubLayerRemoved(object sender, EventArgs eventArgs)
        {
            ...
            {
                _mapVisualizer.RemoveTilesFromLayer(
                    (VectorTileFactory)layerUpdateArgs.factory,
        ...
        private void OnVectorDataUpdateLayer(object sender, System.EventArgs eventArgs)
        {
            ...
            if (layerUpdateArgs.visualizer != null)
            {
                ...
                _mapVisualizer.UnregisterAndRedrawTilesFromLayer(
                    (VectorTileFactory)layerUpdateArgs.factory,
                    layerUpdateArgs.visualizer
                );
            }
        ...
        private Vector3 GeoToWorldPositionXZ(Vector2d latitudeLongitude)
        {
            ...
            var worldPos = Conversions
                .GeoToWorldPosition(
                    latitudeLongitude,
                    CenterMercator,
                    WorldRelativeScale * scaleFactor
                )
                .ToVector3xz();
        ...
        protected virtual float QueryElevationAtInternal(Vector2d latlong, out float tileScale)
        {
            ...
            UnityTile tile;
            bool foundTile = MapVisualizer.ActiveTiles.TryGetValue(
                Conversions.LatitudeLongitudeToTileId(latlong.x, latlong.y, (int)Zoom),
                out tile
            );
            if (foundTile)
            {
                ...
                var _rect = tile.Rect;
                return tile.QueryHeightData(
                    (float)((_meters - _rect.Min).x / _rect.Size.x),
                    (float)((_meters.y - _rect.Max.y) / _rect.Size.y)
                );
            }
            else
            {
        ...
        public virtual Vector3 GeoToWorldPosition(
            Vector2d latitudeLongitude,
            bool queryHeight = true
        )
        {
            ...
            if (queryHeight)
            {
                ...
                UnityTile tile;
                if (
                    MapVisualizer.ActiveTiles.TryGetValue(
                        Conversions.LatitudeLongitudeToTileId(
                            latitudeLongitude.x,
                            latitudeLongitude.y,
                            (int)Zoom
                        ),
        ...
        public virtual Vector2d WorldToGeoPosition(Vector3 realworldPoint)
        {
            ...
            return (Root.InverseTransformPoint(realworldPoint)).GetGeoPosition(
                CenterMercator,
                WorldRelativeScale * scaleFactor
            );
        }
        ...
        public virtual void SetCenterLatitudeLongitude(Vector2d centerLatitudeLongitude)
        {
            _options.locationOptions.latitudeLongitude = string.Format(
                "{0}, {1}",
                centerLatitudeLongitude.x,
                centerLatitudeLongitude.y
            );
