...
namespace Mapbox.Unity.Map
{
    ...
    public abstract class AbstractMapVisualizer : ScriptableObject
    {
        ...
        protected Dictionary<UnwrappedTileId, UnityTile> _activeTiles =
            new Dictionary<UnwrappedTileId, UnityTile>();
                ...
                if (_map.CurrentExtent.Count == _activeTiles.Count)
                {
                    ...
                    foreach (var currentTile in _map.CurrentExtent)
                    {
                        allDone =
                            allDone
                            && (
                                _activeTiles.ContainsKey(currentTile)
        ...
        public virtual UnityTile LoadTile(UnwrappedTileId tileId)
        {
            ...
            if (unityTile == null)
            {
                ...
                catch
                {
                    ...
                    unityTile.MeshRenderer.sharedMaterial = Instantiate(
        ...
        public void UnregisterAndRedrawTilesFromLayer(
            VectorTileFactory factory,
        ...
        public void RemoveTilesFromLayer(
            VectorTileFactory factory,
            LayerVisualizerBase layerVisualizer
        )
        {
