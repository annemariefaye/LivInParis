namespace Mapbox.Unity.Map
{
    ...
    public class PrefabItemOptions : VectorSubLayerProperties
    {
        ...
        public readonly Dictionary<LocationPrefabFindBy, string> layerNameFromFindByTypeDictionary =
            new Dictionary<LocationPrefabFindBy, string>
            {
        ...
        public readonly Dictionary<
            ...
            string
        > categoryPropertyFromFindByTypeDictionary = new Dictionary<LocationPrefabFindBy, string>
        {
            { LocationPrefabFindBy.AddressOrLatLon, "" },
        ...
        public readonly Dictionary<
            LocationPrefabFindBy,
            string
        > densityPropertyFromFindByTypeDictionary = new Dictionary<LocationPrefabFindBy, string>
        {
            { LocationPrefabFindBy.AddressOrLatLon, "" },
        ...
        public readonly Dictionary<
            LocationPrefabFindBy,
            string
        > namePropertyFromFindByTypeDictionary = new Dictionary<LocationPrefabFindBy, string>
        {
            { LocationPrefabFindBy.AddressOrLatLon, "" },
        ...
        public readonly PositionTargetType _movePrefabFeaturePositionTo =
            PositionTargetType.FirstVertex;

        public readonly LayerFilterCombinerOperationType _combinerType =
            LayerFilterCombinerOperationType.All;
        #endregion
        ...
        {
            get { return coreOptions.isActive; }
            set { coreOptions.isActive = value; }
        }

        public bool snapToTerrain
        {
            get { return coreOptions.snapToTerrain; }
            set { coreOptions.snapToTerrain = value; }
        }

        public string prefabItemName
        {
            get { return coreOptions.sublayerName; }
        ...
        {
            get { return spawnPrefabOptions.AllPrefabsInstatiated; }
