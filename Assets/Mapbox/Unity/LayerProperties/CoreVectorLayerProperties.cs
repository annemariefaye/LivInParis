namespace Mapbox.Unity.Map
{
    ...
    public class CoreVectorLayerProperties : MapboxDataProperty, ISubLayerCoreOptions
    {
        ...
        [Tooltip(
            "Primitive geometry type of the visualizer, allowed primitives - point, line, polygon"
        )]
        ...
        [Tooltip(
            "Snap features to the terrain elevation, use this option to draw features above terrain. "
        )]
