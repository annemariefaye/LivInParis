...
namespace Mapbox.Unity.Map
{
    ...
    public class ImageryLayer : AbstractLayer, IImageryLayer
    {
        ...
        {
            get { return MapLayerType.Imagery; }
        }

        public bool IsLayerActive
        {
            get { return (_layerProperty.sourceType != ImagerySourceType.None); }
        }
        ...
        public void Initialize()
        {
            ...
            {
                _layerProperty.sourceOptions.layerSource = MapboxDefaultImagery.GetParameters(
                    _layerProperty.sourceType
                );
            }
        ...
        public virtual void SetLayerSource(ImagerySourceType imageSource)
        {
            ...
            {
                Debug.LogWarning(
                    "Invalid style - trying to set " + imageSource.ToString() + " as default style!"
                );
            }
        }
