...
namespace Mapbox.Unity.Map
{
    ...
    public interface IVectorDataLayer : ILayer
    {
        ...
        void SetLayerSourceWithOptimizedStyle(
            string vectorSource,
            string styleId,
            string modifiedDate,
        ...
        IEnumerable<VectorSubLayerProperties> GetFeatureSubLayerByQuery(
        ...
        IEnumerable<PrefabItemOptions> GetPointsOfInterestSubLayerByQuery(
