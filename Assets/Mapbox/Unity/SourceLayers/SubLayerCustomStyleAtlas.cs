namespace Mapbox.Unity.Map
{
    ...
    public class SubLayerCustomStyleAtlas : ISubLayerCustomStyleAtlas
    {
        ...
        {
            get { return _materialOptions.customStyleOptions.materials[0].Materials[0]; }
            set
            {
        ...
        {
            get { return _materialOptions.customStyleOptions.materials[1].Materials[0]; }
            set
            {
        ...
        {
            get { return _materialOptions.customStyleOptions.atlasInfo; }
            set
            {
