...
namespace Mapbox.Unity.Map
{
    ...
    public class VectorLayer : AbstractLayer, IVectorDataLayer
    {
        ...
        public void Remove()
        {
            _layerProperty = new VectorLayerProperties { sourceType = VectorSourceType.None };
        }
        ...
        private void AddVectorLayer(object sender, EventArgs args)
        {
            ...
            {
                layerUpdateArgs.visualizer = _vectorTileFactory.AddPOIVectorLayerVisualizer(
                    (PrefabItemOptions)layerUpdateArgs.property
                );
            }
            else if (layerUpdateArgs.property is VectorSubLayerProperties)
            {
                layerUpdateArgs.visualizer = _vectorTileFactory.AddVectorLayerVisualizer(
                    (VectorSubLayerProperties)layerUpdateArgs.property
                );
            }
        ...
        private void RemoveVectorLayer(object sender, EventArgs args)
        {
            ...
            layerUpdateArgs.visualizer = _vectorTileFactory.FindVectorLayerVisualizer(
                (VectorSubLayerProperties)layerUpdateArgs.property
            );
            layerUpdateArgs.factory = _vectorTileFactory;
        ...
        public virtual void SetLayerSourceWithOptimizedStyle(
            string vectorSource,
            string styleId,
            string modifiedDate,
        ...
        {
            if (
                LayerProperty.sourceType == VectorSourceType.None
        ...
        public virtual void SpawnPrefabAtGeoLocation(
            GameObject prefab,
            Vector2d LatLon,
        ...
        public virtual void SpawnPrefabByCategory(
            GameObject prefab,
        ...
        /// <param name="scaleDownWithWorld">Should the prefab scale up/down along with the map game object?</param>
        /// </summary>
        public virtual void SpawnPrefabByName(
            GameObject prefab,
            string nameString,
            int density = 30,
            Action<List<GameObject>> callback = null,
        ...
        public virtual void AddFeatureSubLayer(VectorSubLayerProperties subLayerProperties)
        {
            ...
            _layerProperty.OnSubLayerPropertyAdded(
                new VectorLayerUpdateArgs { property = _layerProperty.vectorSubLayers.Last() }
            );
        }

        public virtual void AddPolygonFeatureSubLayer(
            string assignedSubLayerName,
            string dataLayerNameInService
        )
        {
        ...
        public virtual void AddCustomFeatureSubLayer(
            string assignedSubLayerName,
            string dataLayerNameInService
        )
        {
        ...
        public virtual void RemoveFeatureSubLayerWithName(string featureLayerName)
        {
            ...
            if (layerToRemove != null)
            {
                _layerProperty.OnSubLayerPropertyRemoved(
                    new VectorLayerUpdateArgs { property = layerToRemove }
                );
            }
        }
        ...
        public virtual void RemoveFeatureSubLayer(VectorSubLayerProperties layer)
        {
            ...
            _layerProperty.OnSubLayerPropertyRemoved(
                new VectorLayerUpdateArgs { property = layer }
            );
        }
        ...
        public virtual void AddPointsOfInterestSubLayer(PrefabItemOptions poiLayerProperties)
        {
            ...
            _layerProperty.OnSubLayerPropertyAdded(
                new VectorLayerUpdateArgs { property = _layerProperty.locationPrefabList.Last() }
            );
        }
        ...
        public virtual PrefabItemOptions FindPointsofInterestSubLayerWithName(string poiLayerName)
        {
            ...
            return (foundLayerIndex != -1)
                ? _layerProperty.locationPrefabList[foundLayerIndex]
                : null;
        }
        ...
        private void SetLayerSourceInternal(VectorSourceType vectorSource)
        {
            if (vectorSource != VectorSourceType.Custom && vectorSource != VectorSourceType.None)
            {
                ...
                _layerProperty.sourceOptions.layerSource = MapboxDefaultVector.GetParameters(
                    vectorSource
                );
            }
            else
            {
                Debug.LogWarning(
                    "Invalid style - trying to set "
                        + vectorSource.ToString()
                        + " as default style!"
                );
            }
        }
        ...
        private void SetOptimizedStyleInternal(
            string styleId,
            string modifiedDate,
            string styleName
        )
