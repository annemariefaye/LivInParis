...
namespace Mapbox.Unity.Map
{
    ...
    public class TerrainLayer : AbstractLayer, ITerrainLayer, IGlobeTerrainLayer
    {
        ...
        {
            get { return MapLayerType.Elevation; }
        }

        public bool IsLayerActive
        {
            get { return (_layerProperty.sourceType != ElevationSourceType.None); }
        }
        ...
        {
            get { return _layerProperty.sourceType; }
        }

        public ElevationLayerType ElevationType
        {
            get { return _layerProperty.elevationLayerType; }
            set
            {
        ...
        {
            get { return _layerProperty.requiredOptions.exaggerationFactor; }
            set
            {
        ...
        {
            get { return _layerProperty.modificationOptions.earthRadius; }
        ...
        public virtual void SetLayerSource(
            ElevationSourceType terrainSource = ElevationSourceType.MapboxTerrain
        )
        {
            if (
                terrainSource != ElevationSourceType.Custom
                && terrainSource != ElevationSourceType.None
            )
            {
                _layerProperty.sourceType = terrainSource;
                _layerProperty.sourceOptions.layerSource = MapboxDefaultElevation.GetParameters(
                    terrainSource
                );
                _layerProperty.HasChanged = true;
            }
        ...
        public virtual void SetProperties(
            ElevationSourceType dataSource = ElevationSourceType.MapboxTerrain,
