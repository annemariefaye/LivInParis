namespace Mapbox.Unity.Map
{
    ...
    public class SubLayerCustomStyleAtlasWithColorPallete
        : ISubLayerCustomStyleAtlasWithColorPallete
    {
        ...
        {
            get { return _materialOptions.materials[0].Materials[0]; }
            set
            {
        ...
        {
            get { return _materialOptions.materials[1].Materials[0]; }
            set
            {
        ...
        {
            get { return _materialOptions.atlasInfo; }
            set
            {
        ...
        {
            get { return _materialOptions.colorPalette; }
            set
            {
