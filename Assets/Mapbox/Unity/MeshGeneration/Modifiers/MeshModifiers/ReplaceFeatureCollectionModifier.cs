namespace Mapbox.Unity.MeshGeneration.Modifiers
{
    ...
    public class ReplaceFeatureCollectionModifier : GameObjectModifier, IReplacementCriteria
    {
        ...
        private void OnValidate()
        {
            ...
            {
                features[i].Name =
                    (features[i].prefab == null) ? "Feature" : features[i].prefab.name;
            }
        }
        ...
        public override void Initialize()
        {
            ...
            {
                ReplaceFeatureModifier replaceFeatureModifier =
                    ScriptableObject.CreateInstance<ReplaceFeatureModifier>();
                ...
                replaceFeatureModifier.BlockedIds = new List<string>(
                    feature._explicitlyBlockedFeatureIds
                );
