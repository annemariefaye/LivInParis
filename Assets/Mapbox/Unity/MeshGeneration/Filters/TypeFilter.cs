namespace Mapbox.Unity.MeshGeneration.Filters
{
    ...
    public class TypeFilter : FilterBase
    {
        ...
        public override bool Try(VectorFeatureUnity feature)
        {
            ...
            {
                if (
                    _types[i].ToLowerInvariant()
                    == feature.Properties["type"].ToString().ToLowerInvariant()
                )
                {
                    check = true;
                }
    ...
    public class LayerFilterComparer : ILayerFeatureFilterComparer
    {
        ...
        public static ILayerFeatureFilterComparer AnyOf(
            params ILayerFeatureFilterComparer[] filters
        )
        {
        ...
        public static ILayerFeatureFilterComparer AllOf(
            params ILayerFeatureFilterComparer[] filters
        )
        {
            return new LayerFilterCombiner
        ...
        public static ILayerFeatureFilterComparer NoneOf(
            params ILayerFeatureFilterComparer[] filters
        )
        {
            return new LayerFilterCombiner
        ...
        {
            return new LayerHasPropertyFilterComparer { Key = property };
        }

        public static ILayerFeatureFilterComparer HasPropertyInRange(
            string property,
            double min,
            double max
        )
        ...
        public static ILayerFeatureFilterComparer HasPropertyGreaterThan(
            string property,
            double min
        )
        {
            return new LayerPropertyIsGreaterFilterComparer { Key = property, Min = min };
        }

        public static ILayerFeatureFilterComparer HasPropertyLessThan(string property, double min)
        {
            return new LayerPropertyIsLessFilterComparer { Key = property, Min = min };
        }

        public static ILayerFeatureFilterComparer HasPropertyIsEqual(string property, double min)
        {
            return new LayerPropertyIsEqualFilterComparer { Key = property, Min = min };
        }

        public static ILayerFeatureFilterComparer PropertyContainsValue(
            string property,
    ...
    public class LayerFilter : MapboxDataProperty, ILayerFilter
    {
        ...
        public LayerFilter(
            LayerFilterOperationType filterOperation = LayerFilterOperationType.Contains
        )
        {
        ...
        public virtual bool FilterUsesOperationType(
