...
namespace Mapbox.Unity.Utilities
{
    ...
    public static class VectorExtensions
    {
        ...
        /// </code>
        /// </example>
        public static void MoveToGeocoordinate(
            this Transform t,
            double lat,
            double lng,
            Vector2d refPoint,
        ...
        /// <param name="refPoint">Reference point.</param>
        /// <param name="scale">Scale.</param>
        public static Vector3 AsUnityPosition(
            this Vector2 latLon,
            Vector2d refPoint,
            float scale = 1
        )
        {
            return Conversions
                .GeoToWorldPosition(latLon.x, latLon.y, refPoint, scale)
                .ToVector3xz();
        }
        ...
        public static Vector2d GetGeoPosition(
