namespace Mapbox.Editor
{
    ...
    public static class EditorHelper
    {
        ...
        public static void CheckForModifiedProperty<T>(
            SerializedProperty property,
            T targetObject,
            bool forceHasChanged = false
        )
        {
            MapboxDataProperty targetObjectAsDataProperty = GetMapboxDataPropertyObject(
                targetObject
            );
        ...
        public static void CheckForModifiedProperty(
            SerializedProperty property,
            bool forceHasChanged = false
        )
        {
        ...
        public static bool DidModifyProperty<T>(SerializedProperty property, T targetObject)
        {
            ...
            return (
                ...
                && targetObjectAsDataProperty != null
            );
        }
        ...
        public static object GetTargetObjectOfProperty(SerializedProperty prop)
        {
            ...
            foreach (var element in elements)
            {
                if (element.Contains("["))
                {
                    var elementName = element.Substring(
                        0,
                        element.IndexOf("[", StringComparison.CurrentCulture)
                    );
                    var index = System.Convert.ToInt32(
                        element
                            .Substring(element.IndexOf("[", StringComparison.CurrentCulture))
                            .Replace("[", "")
                            .Replace("]", "")
                    );
        ...
        public static int GetChildPropertyCount(
            SerializedProperty property,
