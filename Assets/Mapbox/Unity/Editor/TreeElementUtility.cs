namespace Mapbox.Editor
{
    ...
    public static class TreeElementUtility
    {
            ...
            where T : TreeElement
        {
            ...
            for (int i = 1; i < list.Count; ++i)
                if (list[i].depth < 0)
                    throw new ArgumentException(
                        "Invalid depth value for item at index "
                            + i
            ...
            if (list.Count > 1 && list[1].depth != 0)
                throw new ArgumentException(
                    "Input list item at index 1 is assumed to have a depth of 0",
                    "list"
                );
        }
    ...
    class TreeElementUtilityTests
    {
        ...
        public static void TestListToTreeThrowsExceptionIfRootIsInvalidDepth()
        {
            ...
            Assert.IsTrue(
                catchedException,
                "We require the root.depth to be -1, here it is: " + list[0].depth
            );
        }
        ...
        public static void FindCommonAncestorsWithinListWorks()
        {
            ...
            Assert.IsTrue(
                ArrayUtility.ArrayEquals(expectedResult, result),
            ...
            Assert.IsTrue(
                ArrayUtility.ArrayEquals(expectedResult, result),
                "Common ancestor should only be b1 "
            );
