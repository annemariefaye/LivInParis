    ...
    public class GeometryExtrusionOptionsDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            extrusionTypeProperty.enumValueIndex = EditorGUILayout.Popup(
                extrusionTypeLabel,
                extrusionTypeProperty.enumValueIndex,
                extrusionTypeContent
            );
            ...
            {
                text = "Geometry Type",
                tooltip = EnumExtensions.Description(
                    (Unity.Map.ExtrusionGeometryType)extrusionGeometryType.enumValueIndex
                ),
            };
                ...
                case Unity.Map.ExtrusionType.RangeHeight:
                    ...
                    if (minHeightProperty.floatValue > maxHeightProperty.floatValue)
                    {
                        EditorGUILayout.HelpBox(
                            "Maximum Height less than Minimum Height!",
                            MessageType.Error
                        );
                    }
                    break;
            ...
            EditorGUI.BeginChangeCheck();
            EditorGUILayout.PropertyField(
                property.FindPropertyRelative("extrusionScaleFactor"),
        ...
        )
        {
            ...
            else
            {
                ...
                property.FindPropertyRelative("propertyDescription").stringValue =
                    descriptionString;
            }

            descriptionString = string.IsNullOrEmpty(descriptionString)
            ...
            EditorGUILayout.LabelField(
                propertyDescriptionPrefixLabel,
        ...
        private void DrawWarningMessage(Rect position)
        {
            ...
            EditorGUILayout.LabelField(
                layerNameLabel,
                new GUIContent("No properties found in layer"),
                labelStyle
            );
            return;
        }
