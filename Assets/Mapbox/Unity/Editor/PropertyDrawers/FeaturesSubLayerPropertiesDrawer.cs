namespace Mapbox.Editor
{
    ...
    public class FeaturesSubLayerPropertiesDrawer
    {
        ...
        {
            get { return EditorPrefs.GetString(objectId + "VectorSubLayerProperties_tilesetId"); }
            set { EditorPrefs.SetString(objectId + "VectorSubLayerProperties_tilesetId", value); }
        }

        bool ShowPosition
        {
            get { return EditorPrefs.GetBool(objectId + "VectorSubLayerProperties_showPosition"); }
            set { EditorPrefs.SetBool(objectId + "VectorSubLayerProperties_showPosition", value); }
        }

        int SelectionIndex
        {
            get { return EditorPrefs.GetInt(objectId + "VectorSubLayerProperties_selectionIndex"); }
        ...
        BehaviorModifiersSectionDrawer _behaviorModifierSectionDrawer =
            new BehaviorModifiersSectionDrawer();
        ...
        public void DrawUI(SerializedProperty property)
        {
            ...
            if (!_isGUIContentSet)
            {
                ...
                foreach (var name in names)
                {
                    _sourceTypeContent[index] = new GUIContent
                    {
                        ...
                        tooltip = (
                            (VectorSourceType)Enum.Parse(typeof(VectorSourceType), name)
                        ).Description(),
                    };
                    index++;
                }
            ...
            sourceTypeValue = (
                (VectorSourceType)
                    Enum.Parse(typeof(VectorSourceType), names[sourceTypeProperty.enumValueIndex])
            );
            ...
            if (sourceTypeValue != VectorSourceType.None)
            {
                ...
                if (selectedLayers.Count > 0)
                {
                    ...
                    if (
                        selectedLayers[0] - FeatureSubLayerTreeView.uniqueIdFeature
                ...
                else
                {
                    if (
                        SelectionIndex > 0
                        && (
                            SelectionIndex - FeatureSubLayerTreeView.uniqueIdFeature
                            <= subLayerArray.arraySize - 1
                        )
                    )
                    {
                ...
                {
                    menu.AddItem(
                        new GUIContent() { text = name },
                        false,
                        FetchPresetProperties,
                        name
                    );
                }
                ...
                if (
                    EditorGUILayout.DropdownButton(
                        new GUIContent { text = "Add Feature" },
                        FocusType.Passive,
                ...
                if (subLayerProperties != null)
                {
                    ...
                    var subLayer = subLayerArray.GetArrayElementAtIndex(
                        subLayerArray.arraySize - 1
                    );
                ...
                if (
                    GUILayout.Button(new GUIContent("Remove Selected"), (GUIStyle)"minibuttonright")
                )
                {
                    foreach (var index in selectedLayers.OrderByDescending(i => i))
                    {
                        ...
                        {
                            var subLayer = subLayerArray.GetArrayElementAtIndex(
                                index - FeatureSubLayerTreeView.uniqueIdFeature
                            );

                            VectorLayerProperties vectorLayerProperties = (VectorLayerProperties)
                                EditorHelper.GetTargetObjectOfProperty(property);
                            VectorSubLayerProperties vectorSubLayerProperties =
                                (VectorSubLayerProperties)
                                    EditorHelper.GetTargetObjectOfProperty(subLayer);

                            vectorLayerProperties.OnSubLayerPropertyRemoved(
                                new VectorLayerUpdateArgs { property = vectorSubLayerProperties }
                            );

                            layerTreeView.RemoveItemFromTree(index);
                            subLayerArray.DeleteArrayElementAtIndex(
                                index - FeatureSubLayerTreeView.uniqueIdFeature
                            );
                ...
                )
                {
                    ...
                    var layerProperty = subLayerArray.GetArrayElementAtIndex(
                        SelectionIndex - FeatureSubLayerTreeView.uniqueIdFeature
                    );

                    layerProperty.isExpanded = true;
                    var subLayerCoreOptions = layerProperty.FindPropertyRelative("coreOptions");
                    bool isLayerActive = subLayerCoreOptions
                        .FindPropertyRelative("isActive")
                        .boolValue;
                    if (!isLayerActive)
                    {
                        GUI.enabled = false;
        ...
        {
            PresetFeatureType featureType = (
                (PresetFeatureType)Enum.Parse(typeof(PresetFeatureType), name.ToString())
            );
        ...
        void SetSubLayerProps(SerializedProperty subLayer)
        {
            ...
            subLayer.FindPropertyRelative("presetFeatureType").enumValueIndex = (int)
                subLayerProperties.presetFeatureType;
            ...
            subLayerCoreOptions.FindPropertyRelative("layerName").stringValue =
                coreOptions.layerName;
            subLayerCoreOptions.FindPropertyRelative("geometryType").enumValueIndex = (int)
                coreOptions.geometryType;
            subLayerCoreOptions.FindPropertyRelative("snapToTerrain").boolValue =
                coreOptions.snapToTerrain;
            subLayerCoreOptions.FindPropertyRelative("combineMeshes").boolValue =
                coreOptions.combineMeshes;
            ...
            subLayerlineGeometryOptions.FindPropertyRelative("Width").floatValue =
                lineGeometryOptions.Width;
            subLayerlineGeometryOptions.FindPropertyRelative("CapType").enumValueIndex = (int)
                lineGeometryOptions.CapType;
            subLayerlineGeometryOptions.FindPropertyRelative("JoinType").enumValueIndex = (int)
                lineGeometryOptions.JoinType;
            subLayerlineGeometryOptions.FindPropertyRelative("MiterLimit").floatValue =
                lineGeometryOptions.MiterLimit;
            subLayerlineGeometryOptions.FindPropertyRelative("RoundLimit").floatValue =
                lineGeometryOptions.RoundLimit;
            ...
            subLayerExtrusionOptions.FindPropertyRelative("extrusionType").enumValueIndex = (int)
                extrusionOptions.extrusionType;
            ...
            subLayerExtrusionOptions.FindPropertyRelative("propertyName").stringValue =
                extrusionOptions.propertyName;
            subLayerExtrusionOptions.FindPropertyRelative("extrusionScaleFactor").floatValue =
                extrusionOptions.extrusionScaleFactor;
            subLayerExtrusionOptions.FindPropertyRelative("maximumHeight").floatValue =
                extrusionOptions.maximumHeight;
            ...
            subLayerFilterOptions.FindPropertyRelative("combinerType").enumValueIndex = (int)
                filterOptions.combinerType;
            ...
            subLayerGeometryMaterialOptions.FindPropertyRelative("style").enumValueIndex = (int)
            ...
            var lightStyleOpacity = subLayerGeometryMaterialOptions.FindPropertyRelative(
                "lightStyleOpacity"
            );
            var darkStyleOpacity = subLayerGeometryMaterialOptions.FindPropertyRelative(
                "darkStyleOpacity"
            );
            var colorStyleColor = subLayerGeometryMaterialOptions.FindPropertyRelative(
                "colorStyleColor"
            );
            var customStyleOptions = subLayerGeometryMaterialOptions.FindPropertyRelative(
                "customStyleOptions"
            );
            ...
            var customTopMatArray = customMats
                .GetArrayElementAtIndex(0)
                .FindPropertyRelative("Materials");
            var customSideMatArray = customMats
            ...
            customTopMat.objectReferenceValue = materialOptions
                .customStyleOptions
                .materials[0]
                .Materials[0];
            customSideMat.objectReferenceValue = materialOptions
                .customStyleOptions
                .materials[1]
                .Materials[0];
            ...
            subLayer.FindPropertyRelative("moveFeaturePositionTo").enumValueIndex = (int)
                subLayerProperties.moveFeaturePositionTo;
            ...
            subLayerColliderOptions.FindPropertyRelative("colliderType").enumValueIndex = (int)
                subLayerProperties.colliderOptions.colliderType;
        }
        ...
        void DrawLayerVisualizerProperties(
        ...
        )
        {
            ...
            var subLayerType = PresetSubLayerPropertiesFetcher.GetPresetTypeFromLayerName(
                visualizerLayer
            );
            ...
            GUILayout.Space(_lineHeight);
            //*********************** LAYER NAME BEGINS ***********************************//
            VectorPrimitiveType primitiveTypeProp = (VectorPrimitiveType)
                subLayerCoreOptions.FindPropertyRelative("geometryType").enumValueIndex;
            ...
            if (
                primitiveTypeProp != VectorPrimitiveType.Point
                && primitiveTypeProp != VectorPrimitiveType.Custom
            )
            {
                GUILayout.Space(-_lineHeight);
                EditorGUILayout.PropertyField(
                    layerProperty.FindPropertyRelative("materialOptions")
                );
            }
        ...
        private void LoadEditorTileJSON(
            SerializedProperty property,
            VectorSourceType sourceTypeValue,
            string sourceString
        )
        {
            ...
            {
                if (
                    tileJSONResponse == null
                    || string.IsNullOrEmpty(sourceString)
                    || sourceString != TilesetId
                )
                {
                    try
                    {
        ...
        public void DrawLayerName(SerializedProperty property, List<string> layerDisplayNames)
        {
            var layerNameLabel = new GUIContent
            {
                text = "Data Layer",
                tooltip =
                    "The layer name from the Mapbox tileset that would be used for visualizing a feature",
            };
            ...
            if (layerDisplayNames.Count == 0)
            {
                EditorGUILayout.LabelField(
                    layerNameLabel,
                    new GUIContent("No layers found: Invalid TilesetId / No Internet."),
                    (GUIStyle)"minipopUp"
                );
                return;
            }
            ...
            else
            {
                ...
                {
                    tileJsonData.LayerPropertyDescriptionDictionary.Add(
                        layerString,
            ...
            {
                _layerTypeContent[extIdx] = new GUIContent { text = layerDisplayNames[extIdx] };
            }

            //draw the layer selection popup
            _layerIndex = EditorGUILayout.Popup(layerNameLabel, _layerIndex, _layerTypeContent);
            var parsedString = layerDisplayNames
                .ToArray()[_layerIndex]
                .Split(
                    new string[] { tileJsonData.commonLayersKey },
        ...
        private string[] GetSubTypeValues(
            SerializedProperty layerProperty,
            string visualizerLayer,
            VectorSourceType sourceType
        )
        {
            ...
            if (visualizerLayer == roadLayer || visualizerLayer == landuseLayer)
            {
                ...
                if (
                    _streetsV7TileStats != null
                    && _streetsV7TileStats.layers != null
                ...
                )
                {
                    foreach (var layer in _streetsV7TileStats.layers)
                    {
                        ...
                        {
                            presetPropertyName = layerProperty
                                .FindPropertyRelative("roadLayer_TypeProperty")
                                .stringValue;
                        }
                        else if (layer.layer == landuseLayer)
                        {
                            presetPropertyName = layerProperty
                                .FindPropertyRelative("landuseLayer_TypeProperty")
                                .stringValue;
                        }
