namespace Mapbox.Editor
{
    ...
    public class VectorLayerPropertiesDrawer
    {
        ...
        bool ShowFeatures
        {
            get { return EditorPrefs.GetBool(objectId + "VectorLayerProperties_showFeatures"); }
        ...
        FeaturesSubLayerPropertiesDrawer _vectorSublayerDrawer =
            new FeaturesSubLayerPropertiesDrawer();
        PointsOfInterestSubLayerPropertiesDrawer _poiSublayerDrawer =
            new PointsOfInterestSubLayerPropertiesDrawer();
        ...
        public void DrawUI(SerializedProperty property)
        {
            ...
            string streets_v7 = MapboxDefaultVector
                .GetParameters(VectorSourceType.MapboxStreets)
                .Id;
            ...
            ShowLocationPrefabs = EditorGUILayout.Foldout(
                ShowLocationPrefabs,
                "POINTS OF INTEREST"
            );
        ...
        public void PostProcessLayerProperties(SerializedProperty property)
        {
            ...
            {
                if (
                    _poiSublayerDrawer.isLayerAdded == true
                    && sourceTypeValue != VectorSourceType.None
                ...
                )
                {
                    ...
                    PrefabItemOptions prefabItemOptionToAdd =
                        (PrefabItemOptions)EditorHelper.GetTargetObjectOfProperty(prefabItem)
                        as PrefabItemOptions;
                    (
                        (VectorLayerProperties)EditorHelper.GetTargetObjectOfProperty(property)
                    ).OnSubLayerPropertyAdded(
