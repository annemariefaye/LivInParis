namespace Mapbox.Editor
{
    ...
    public class GeometryMaterialOptionsDrawer : PropertyDrawer
    {
        ...
        bool showTexturing
        {
            get { return EditorPrefs.GetBool(objectId + "VectorSubLayerProperties_showTexturing"); }
            set { EditorPrefs.SetBool(objectId + "VectorSubLayerProperties_showTexturing", value); }
        }

        private Dictionary<StyleTypes, StyleIconBundle> _styleIconBundles = new Dictionary<
            StyleTypes,
            StyleIconBundle
        >()
        {
        ...
        private Dictionary<SamplePalettes, StyleIconBundle> _paletteIconBundles = new Dictionary<
            SamplePalettes,
            StyleIconBundle
        >()
        {
            {
                SamplePalettes.City,
                new StyleIconBundle(StyleTypes.Simple.ToString(), SamplePalettes.City.ToString())
            },
            {
                SamplePalettes.Cool,
                new StyleIconBundle(StyleTypes.Simple.ToString(), SamplePalettes.Cool.ToString())
            },
            {
            ...
            {
                SamplePalettes.Urban,
                new StyleIconBundle(StyleTypes.Simple.ToString(), SamplePalettes.Urban.ToString())
            },
            {
                SamplePalettes.Warm,
                new StyleIconBundle(StyleTypes.Simple.ToString(), SamplePalettes.Warm.ToString())
            },
        };
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (showTexturing)
            {
                ...
                GUIContent[] styleTypeGuiContent = new GUIContent[
                    styleType.enumDisplayNames.Length
                ];
                ...
                if ((StyleTypes)styleType.enumValueIndex != StyleTypes.Custom)
                {
                    ...
                    EditorGUILayout.LabelField(
                        new GUIContent(" ", thumbnailTexture),
                        Constants.GUI.Styles.EDITOR_TEXTURE_THUMBNAIL_STYLE,
                        GUILayout.Height(60),
                        GUILayout.Width(EditorGUIUtility.labelWidth - 60)
                    );
                    ...
                    switch ((StyleTypes)styleType.enumValueIndex)
                    {
                        case StyleTypes.Simple:
                            ...
                            GUIContent[] samplePaletteTypeGuiContent = new GUIContent[
                                samplePaletteType.enumDisplayNames.Length
                            ];
                            ...
                            samplePaletteType.enumValueIndex = EditorGUILayout.Popup(
                                samplePaletteTypeLabel,
                                samplePaletteType.enumValueIndex,
                                samplePaletteTypeGuiContent
                            );
                            break;
                        case StyleTypes.Light:
                            property.FindPropertyRelative("lightStyleOpacity").floatValue =
                        ...
                        case StyleTypes.Dark:
                            property.FindPropertyRelative("darkStyleOpacity").floatValue =
                                EditorGUILayout.Slider(
                                    "Opacity",
                                    property.FindPropertyRelative("darkStyleOpacity").floatValue,
                                    0.0f,
                        ...
                        case StyleTypes.Color:
                            property.FindPropertyRelative("colorStyleColor").colorValue =
                ...
                else
                {
                    ...
                    int valIndex =
                        texturingType.enumValueIndex == 0 ? 0 : texturingType.enumValueIndex + 1;
                    ...
                    EditorGUILayout.PropertyField(
                        matList.GetArrayElementAtIndex(0),
                        new GUIContent
                        {
                            text = "Top Material",
                    ...
                    EditorGUI.BeginChangeCheck();
                    EditorGUILayout.PropertyField(
                        matList.GetArrayElementAtIndex(1),
                        new GUIContent
                        {
                            text = "Side Material",
                    ...
                    if (
                        (UvMapType)texturingType.enumValueIndex + 1
