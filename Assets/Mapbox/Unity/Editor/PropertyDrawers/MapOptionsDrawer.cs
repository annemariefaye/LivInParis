...
namespace Mapbox.Editor
{
    ...
    public class MapOptionsDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            position.y += EditorGUI.GetPropertyHeight(
                property.FindPropertyRelative("locationOptions")
            );
            ...
            else
            {
                ...
                position.y += EditorGUI.GetPropertyHeight(
                    property.FindPropertyRelative("extentOptions")
                );
            }
            ...
            if (showPosition)
            {
                ...
                position.y += EditorGUI.GetPropertyHeight(
                    property.FindPropertyRelative("placementOptions")
                );
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            if (showPosition)
            {
                ...
                height += EditorGUI.GetPropertyHeight(
                    property.FindPropertyRelative("scalingOptions")
                );
            }
