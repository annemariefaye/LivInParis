namespace Mapbox.Editor
{
    ...
    public class GeocodeAttributeSearchWindow : EditorWindow
    {
        ...
        {
            GeocodeAttributeSearchWindow window =
                EditorWindow.GetWindow<GeocodeAttributeSearchWindow>(true, "Search for location");
            ...
            else
            {
                ...
                if (_features.Count > 0)
                {
                    ...
                    for (int i = 0; i < _features.Count; i++)
                    {
                        ...
                        string coordinates =
                            feature.Center.x.ToString(CultureInfo.InvariantCulture)
                            + ", "
                        ...
                        {
                            if (
                                buttonContent.Length + featureNameSplit[j].Length
                                < maxButtonContentLength
                            )
                            {
                        ...
                        if (GUILayout.Button(buttonContent))
                        {
                            ...
                            EditorUtility.SetDirty(
                                _coordinateProperty.serializedObject.targetObject
                            );
