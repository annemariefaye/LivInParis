...
namespace Mapbox.Map
{
    ...
    /// </code>
    /// </example>
    public sealed class Map<T> : Mapbox.Utils.IObservable<T>
        where T : Tile, new()
    {
        /// <summary>
        ...
        {
            get { return this.latLngBounds; }
            set { this.latLngBounds = value; }
        }
        ...
        {
            get { return this.latLngBounds.Center; }
            set { this.latLngBounds.Center = value; }
        }
        ...
        public int Zoom
        {
            ...
            set { this.zoom = Math.Max(0, Math.Min(20, value)); }
        }
