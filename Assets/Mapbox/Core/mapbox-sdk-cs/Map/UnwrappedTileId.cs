...
namespace Mapbox.Map
{
    ...
    public struct UnwrappedTileId : IEquatable<UnwrappedTileId>
    {
        ...
        {
            get { return new CanonicalTileId(this); }
        }
        ...
        {
            return this.X == ((UnwrappedTileId)obj).X
                && this.Y == ((UnwrappedTileId)obj).Y
                && this.Z == ((UnwrappedTileId)obj).Z;
        }
        ...
        {
            get { return new UnwrappedTileId(Z, X, Y - 1); }
        }

        public UnwrappedTileId East
        {
            get { return new UnwrappedTileId(Z, X + 1, Y); }
        }
        ...
        {
            get { return new UnwrappedTileId(Z, X + 1, Y - 1); }
        }
