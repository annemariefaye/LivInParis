...
namespace Mapbox.MapboxSdkCs.UnitTest
{
    ...
    internal class DirectionResourceTest
    {
        ...
        public void GetUrl()
        {
            ...
            Assert.AreEqual(
                "https://api.mapbox.com/directions/v5/mapbox/driving/10.00000,10.00000;20.00000,20.00000.json?alternatives=false".ToLower(),
                _directionResource.GetUrl()
            );
            ...
            {
                new BearingFilter(90, 45),
                new BearingFilter(90, 30),
            };
            Assert.AreEqual(
                "https://api.mapbox.com/directions/v5/mapbox/driving/10.00000,10.00000;20.00000,20.00000.json?alternatives=false&bearings=90%2C45%3B90%2C30".ToLower(),
                _directionResource.GetUrl().ToLower()
            );
            ...
            {
                new BearingFilter(90, 45),
                new BearingFilter(null, null),
            };
            Assert.AreEqual(
                "https://api.mapbox.com/directions/v5/mapbox/driving/10.00000,10.00000;20.00000,20.00000.json?alternatives=false&bearings=90%2C45%3B".ToLower(),
                _directionResource.GetUrl().ToLower()
            );
            ...
            Assert.AreEqual(
                "https://api.mapbox.com/directions/v5/mapbox/driving/10.00000,10.00000;20.00000,20.00000.json?alternatives=false&bearings=90%2C45%3B&continue_straight=false".ToLower(),
                _directionResource.GetUrl().ToLower()
            );
            ...
            Assert.AreEqual(
                "https://api.mapbox.com/directions/v5/mapbox/driving/10.00000,10.00000;20.00000,20.00000.json?alternatives=false&bearings=90%2C45%3B&continue_straight=false&overview=full".ToLower(),
                _directionResource.GetUrl().ToLower()
            );
            ...
            Assert.AreEqual(
                "https://api.mapbox.com/directions/v5/mapbox/driving/10.00000,10.00000;20.00000,20.00000.json?alternatives=false&bearings=90%2C45%3B&continue_straight=false&overview=full&radiuses=30%2C30".ToLower(),
                _directionResource.GetUrl().ToLower()
            );
            ...
            Assert.AreEqual(
                "https://api.mapbox.com/directions/v5/mapbox/driving/10.00000,10.00000;20.00000,20.00000.json?alternatives=false&bearings=90%2C45%3B&continue_straight=false&overview=full&radiuses=30%2C30&steps=false".ToLower(),
                _directionResource.GetUrl().ToLower()
            );
