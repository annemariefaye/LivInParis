...
namespace Mapbox.MapboxSdkCs.UnitTest
{
    ...
    internal class Vector2dBoundsTest
    {
        ...
        {
            var bounds1 = new Vector2dBounds(new Vector2d(-10, -10), new Vector2d(10, 10));
            var bounds2 = Vector2dBounds.FromCoordinates(
                new Vector2d(10, 10),
                new Vector2d(-10, -10)
            );
        ...
        public void Center()
        {
            ...
            Assert.AreEqual(
                new Vector2dBounds(new Vector2d(10, 10), new Vector2d(10, 10)),
                bounds1
            );
            ...
            Assert.AreEqual(
                new Vector2dBounds(new Vector2d(0, -10), new Vector2d(20, 30)),
                bounds3
            );
        }
    }
