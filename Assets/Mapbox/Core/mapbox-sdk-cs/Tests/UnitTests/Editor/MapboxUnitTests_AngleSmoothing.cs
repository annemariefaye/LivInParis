    ...
    internal class AngleSmoothingTest
    {
        ...
        public void Average()
        {
            ...
            Assert.AreEqual(
                355d,
                avg.Calculate(),
                opName + "did not properly calculate back across 0"
            );
            ...
            Assert.AreEqual(
                140d,
                avg.Calculate(),
                opName + "internal default buffer of 5 did not roll over correctly"
            );
        }
        ...
        public void LowPass()
        {
            ...
            Assert.AreEqual(
                5d,
                lp.Calculate(),
                opName + "did not *not* smooth across '0' as expected"
            );
            ...
            Assert.AreEqual(
                8.14d,
                lp.Calculate(),
                opName + "did not smooth across '0' as expected"
            );
            lp.Add(320);
            Assert.AreEqual(
                344.02d,
                lp.Calculate(),
                opName + "did not smooth back across '0' as expected"
            );
        }
        ...
        public void Weighted()
        {
            ...
            Assert.AreEqual(
                350.43d,
                ema.Calculate(),
                opName + "didn't smooth as expected back across 0"
            );
        }
    }
}
