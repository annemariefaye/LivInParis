...
namespace Mapbox.MapboxSdkCs.UnitTest
{
    ...
    internal class MapMatcherTest
    {
        ...
        public IEnumerator AsSimpleAsPossible()
        {
            ...
            Assert.AreEqual(
                3,
                matchingResponse.Tracepoints[3].WaypointIndex,
                "Wrong WaypointIndex"
            );

            Assert.AreEqual(1, matchingResponse.Matchings.Length, "Wrong number of matchings");
            Assert.That(
                matchingResponse.Matchings[0].Weight > 0
                    && matchingResponse.Matchings[0].Weight < 100,
                "Wrong Weight: {0}",
                matchingResponse.Matchings[0].Weight
            );
            Assert.AreEqual(
                "routability",
                matchingResponse.Matchings[0].WeightName,
                "Wrong WeightName"
            );
            Assert.AreEqual(6, matchingResponse.Matchings[0].Legs.Count, "Wrong number of legs");
            Assert.AreEqual(
                8,
                matchingResponse.Matchings[0].Geometry.Count,
                "Wrong number of vertices in geometry"
            );
        }
        ...
        public IEnumerator Profiles()
        {
            ...
            Assert.GreaterOrEqual(
                matchingResponse.Matchings[0].Duration,
                300,
                "'mapbox/walking' duration [{0}] less than expected",
                matchingResponse.Matchings[0].Duration
            );
            ...
            Assert.GreaterOrEqual(
                matchingResponse.Matchings[0].Duration,
                100,
                "'driving' duration less than expected"
            );
        }
        ...
        public IEnumerator NoSegment()
        {
            ...
            Assert.AreEqual(
                "Could not find a matching segment for input coordinates",
        ...
        public IEnumerator Radiuses()
        {
            ...
            Assert.AreEqual(
                1,
                matchingResponse.Tracepoints[1].WaypointIndex,
                "Wrong WaypointIndex"
            );
        ...
        public IEnumerator AlternativesWithSteps()
        {
            ...
            Assert.GreaterOrEqual(
                2,
                matchingResponse.Tracepoints[0].AlternativesCount,
                "Wrong 'AlternativesCount' for Tracepoint[0]"
            );
            Assert.GreaterOrEqual(
                19,
                matchingResponse.Tracepoints[1].AlternativesCount,
            ...
            Assert.AreEqual(
                2,
                matchingResponse.Matchings[0].Legs[0].Steps.Count,
                "Wrong number of steps"
            );
            Assert.IsNotNull(
                matchingResponse.Matchings[0].Legs[0].Steps[0].Intersections,
                "Intersections are NULL"
            );
            Assert.AreEqual(
                3,
                matchingResponse.Matchings[0].Legs[0].Steps[0].Intersections.Count,
        ...
        public IEnumerator LanguageEnglish()
        {
            ...
            Assert.AreEqual(
                "Head northeast on Rechte Wienzeile (B1)",
                step0.Maneuver.Instruction,
                "Step[0]:Instruction not as expected"
            );
            Assert.AreEqual(
                "You have arrived at your destination",
                step1.Maneuver.Instruction,
        ...
        public IEnumerator LanguageGerman()
        {
            ...
            Directions.Step step1 = matchingResponse.Matchings[0].Legs[0].Steps[1];
            Assert.AreEqual(
                "Fahren Sie Richtung Nordosten auf Rechte Wienzeile (B1)",
                step0.Maneuver.Instruction,
                "Step[0]:Instruction not as expected"
            );
            Assert.AreEqual(
        ...
        public IEnumerator AllParameters()
        {
            ...
            Directions.Step step1 = matchingResponse.Matchings[0].Legs[0].Steps[1];
            Assert.IsTrue(
                step1.Maneuver.Instruction.Contains("Sie haben Ihr Ziel erreicht"),
                "Step[1]:Instruction not as expected"
            );
        }
        ...
        public IEnumerator InvalidCoordinate()
        {
            ...
            Assert.AreEqual(
                "InvalidInput",
                matchingResponse.Code,
                "Matching code != 'InvalidInput'"
            );
            ...
            Assert.AreEqual(
                "Coordinate is invalid: 32.71204,-117.17283",
                matchingResponse.Message,
        ...
        private void commonBasicResponseAsserts(MapMatchingResponse matchingResponse)
        {
            ...
            Assert.GreaterOrEqual(
                matchingResponse.Tracepoints.Length,
                2,
                "Less than 2 tracepoints"
            );
            ...
            Assert.GreaterOrEqual(
                matchingResponse.Matchings[0].Legs.Count,
                1,
                "1st match has no legs"
            );
        }
    }
}
