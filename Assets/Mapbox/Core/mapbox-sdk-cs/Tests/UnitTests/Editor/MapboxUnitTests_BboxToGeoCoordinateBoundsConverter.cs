    ...
    internal class BboxToVector2dBoundsConverterTest
    {
        ...
        public void Deserialize()
        {
            Vector2dBounds deserializedVector2dBounds =
                JsonConvert.DeserializeObject<Vector2dBounds>(
                    geoCoordinateBoundsStr,
                    JsonConverters.Converters
                );
            Assert.AreEqual(
                geoCoordinateBoundsObj.ToString(),
                deserializedVector2dBounds.ToString()
            );
        }
        ...
        {
            string serializedVector2dBounds = JsonConvert.SerializeObject(
                geoCoordinateBoundsObj,
                JsonConverters.Converters
            );
