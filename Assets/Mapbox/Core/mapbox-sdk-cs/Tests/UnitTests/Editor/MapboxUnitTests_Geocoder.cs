...
namespace Mapbox.MapboxSdkCs.UnitTest
{
    ...
    internal class GeocoderTest
    {
        ...
        ); //MapboxAccess.Instance.Geocoder;
        private string _forwardResponse =
        ...
        private string _reverseResponse =
        ...
        public void SerializesAndDeserializesReverse()
        {
            ...
            ReverseGeocodeResponse reverseResp = _geocoder.Deserialize<ReverseGeocodeResponse>(
                _reverseResponse
            );

            // Then deserialize it back to a string.
            string reverseReserialized = JsonConvert.SerializeObject(
                reverseResp,
        ...
        {
            // First, deserialize the example response
            ForwardGeocodeResponse forwardResp = _geocoder.Deserialize<ForwardGeocodeResponse>(
                _forwardResponse
            );

            // Then deserialize it back to a string.
            string forwardReserialized = JsonConvert.SerializeObject(
                forwardResp,
                JsonConverters.Converters
            );
