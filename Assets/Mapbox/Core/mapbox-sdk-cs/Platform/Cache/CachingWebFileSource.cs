namespace Mapbox.Platform.Cache
{
    ...
    public class CachingWebFileSource : IFileSource, IDisposable
    {
        ...
        public CachingWebFileSource(
            string accessToken,
            Func<string> getMapsSkuToken,
        ...
        )
        {
            ...
            if (!string.IsNullOrEmpty(_accessToken))
            {
                ...
                {
                    uriBuilder.Query =
                        uriBuilder.Query.Substring(1) + "&" + accessTokenQuery + "&" + mapsSkuToken;
                }
                else
                {
            ...
            if (null != cachedItem)
            {
                ...
                UnityEngine.Debug.LogFormat(
                    ...
                    tilesetId,
                    tileId,
                    null != cachedItem.Data
                        ? cachedItem.Data.Length.ToString()
                        : "cachedItem.Data is NULL"
                );
#endif
                ...
                if (_autoRefreshCache)
                {
                    ...
                    IAsyncRequestFactory.CreateRequest(
                        ...
                        (Response headerOnly) =>
                        {
                            ...
                            if (
                                !string.IsNullOrEmpty(cachedItem.ETag)
        ...
        private IAsyncRequest requestTileAndCache(
            string url,
            string tilesetId,
            ...
            return IAsyncRequestFactory.CreateRequest(
                ...
                (Response r) =>
                {
                    ...
                    if (!r.HasError && null != r.Data)
                    {
                        ...
                        {
                            UnityEngine.Debug.LogWarningFormat(
                                "no 'ETag' header present in response for {0}",
                                url
                            );
                        }
                        else
