...
namespace Mapbox.Platform
{
    ...
    internal sealed class HTTPRequestNonThreaded : IAsyncRequest
    {
        ...
        private void setupRequest()
        {
            ...
            _request.CachePolicy = new System.Net.Cache.RequestCachePolicy(
        ...
        private async void EvaluateResponse(HttpResponseMessage apiResponse, Exception apiEx)
        {
            ...
            _sync.Post(
                delegate
                {
                    callCallbackAndcleanUp(response);
                },
                null
            );
#else
...
#if !NETFX_CORE
        private void getResponseNonThreaded(
            HttpWebRequest request,
            Action<HttpWebResponse, Exception> gotResponse
        )
        {
