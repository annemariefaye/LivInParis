namespace Mapbox.Utils
{
    ...
    public struct Vector2d
    {
        ...
        {
            get { return Mathd.Sqrt(this.x * this.x + this.y * this.y); }
        }
        ...
        {
            get { return new Vector2d(0.0d, 1d); }
        }

        public static Vector2d right
        {
            get { return new Vector2d(1d, 0.0d); }
        }
        ...
        {
            return Mathd.Acos(Mathd.Clamp(Vector2d.Dot(from.normalized, to.normalized), -1d, 1d))
                * 57.29578d;
        }
