...
namespace Mapbox.Directions
{
    ...
    public class DirectionResource : Resource
    {
        ...
        {
            get { return this.alternatives; }
            set { this.alternatives = value; }
        }
        ...
        {
            get { return this.bearings; }
            set
            {
                if (value != null && value.Length != this.coordinates.Length)
                {
                    throw new Exception(
                        "There must be as many bearings as there are coordinates in the request."
                    );
                }
        ...
        {
            get { return this.continueStraight; }
            set { this.continueStraight = value; }
        }
