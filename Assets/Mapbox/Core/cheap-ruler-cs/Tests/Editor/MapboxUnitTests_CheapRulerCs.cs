    ...
    internal class CheapRulerCsTest
    {
        ...
        public void DistanceInMiles()
        {
            ...
            double distKm = ruler.Distance(
                new double[] { 30.5, 32.8351 },
                new double[] { 30.51, 32.8451 }
            );
        ...
        public void DistanceInNauticalMiles()
        {
            ...
            Assert.AreEqual(
                1.852,
                distKm / distNauticalMiles,
                1e-12,
                "wrong distance km vs nautical miles"
            );
            Assert.AreEqual(
                1.15078,
                distMiles / distNauticalMiles,
                1e-6,
                "wrong distance miles vs nautical miles"
            );
        }
        ...
        public void FromTile()
        {
            ...
            Assert.AreEqual(
                ruler1.Distance(p1, p2),
                ruler2.Distance(p1, p2),
                3e-5,
                "CheapRuler.FromTile distance"
            );
        }
