namespace Mapbox.CheapRulerCs
{
    ...
    public class CheapRuler
    {
        ...
        /// <returns></returns>
        public static CheapRuler FromTile(
            int y,
            int z,
            CheapRulerUnits units = CheapRulerUnits.Kilometers
        )
        {
        ...
        public double[] Destination(double[] p, double distance, double bearing)
        {
            ...
            return offset(p, Math.Cos(a) * distance, Math.Sin(a) * distance);
        }
        ...
        {
            return new double[] { p[0] + dx / _kx, p[1] + dy / _ky };
        }
    }
}
