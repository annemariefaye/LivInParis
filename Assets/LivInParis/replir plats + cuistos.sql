...
VALUES
    (
        'cuisinechloe',
        '$5$rounds=5000$steamedhamscuisinechloe$JekHnQji2D74yYMFUoHgox9wO.q6gTLH0oUQ50DIIM7',
        '$5$rounds=5000$steamedhamscuisinechloe$',
        'Chloe',
        'Martin',
        '75 rue de Paris, 75015 Paris',
        '0611223344',
        'chloe@example.com',
        1
    ),
    (
        'chefjean',
        '$5$rounds=5000$steamedhamschefjean$L2Ds5lQyxcz8O7ZUI5wQ8IksLVhvMiYlWxRx0kKikm4',
        '$5$rounds=5000$steamedhamschefjean$',
        'Jean',
        'Dupont',
    ...
    (
        'sushikaren',
        '$5$rounds=5000$steamedhamssushikaren$DY3FVPov.ZmpwFQHKjWRjw1JwXvDDxAwWpboOQ2skw8',
        '$5$rounds=5000$steamedhamssushikaren$',
        'Karen',
        'Ito',
        '4 rue du Japon, 75013 Paris',
        '0633445566',
        'karen@example.com',
        3
    );
...
INSERT INTO
    ListeIngredients (IdIngredient, IdRecette, Quantite)
VALUES
