...
namespace PbSI
{
    ...
    /// <summary>
    /// Classe permettant de gérer la simulation visuelle d'un graphe.
    /// </summary>
    public class VisuelSimu : MonoBehaviour
    {
        ...
        #region Méthodes
        /// <summary>
        /// Méthode appelée au démarrage de la simulation.
        /// </summary>
        async void Start()
        {
        ...
        /// <summary>
        /// Méthode appelée à chaque frame pour mettre à jour la simulation.
        /// </summary>
        void Update()
        {
            UpdateSousGraphe();
