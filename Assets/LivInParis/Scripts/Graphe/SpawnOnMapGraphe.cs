...
namespace PbSI
{
    ...
    /// <summary>
    /// Classe permettant de gérer le placement des objets sur la carte en fonction du graphe.
    /// </summary>
    public class SpawnOnMapGraphe : MonoBehaviour
    {
        ...
        #region Méthodes
        /// <summary>
        /// Méthode appelée au démarrage pour initialiser le placement des objets.
        /// </summary>
        void Start()
        {
            if (!_initialized)
        ...
        /// <summary>
        /// Méthode appelée à chaque frame pour mettre à jour le placement des objets.
        /// </summary>
        private void Update()
        {
            if (_spawnedObjects == null || _locations == null)
                return;
