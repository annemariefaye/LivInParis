...
{
    /// <summary>
    /// Classe permettant de gérer les aspects visuels d'un graphe.
    /// </summary>
    public class Visuel : MonoBehaviour
    {
        ...
        #region Méthodes
        /// <summary>
        /// Méthode appelée au démarrage pour initialiser les visuels.
        /// </summary>
        async void Start()
        {
        ...
        /// <summary>
        /// Méthode appelée à chaque frame pour mettre à jour les visuels.
        /// </summary>
        void Update()
        {
            UpdateGraphComplet();
