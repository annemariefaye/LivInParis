...
--
-- Current Database: `livinparis`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `livinparis` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
INSERT INTO `client` VALUES (1,'Boulangerie Dupont','mdp123'),(2,'Entreprise XYZ','xyz789');
...
CREATE TABLE `commande` (
  ...
  CONSTRAINT `commande_ibfk_1` FOREIGN KEY (`IdClient`) REFERENCES `utilisateur` (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `commande` VALUES (1,1,'2025-04-02 17:48:12','En attente'),(2,2,'2025-04-02 17:48:12','Validée');
...
CREATE TABLE `correspondance` (
  ...
  CONSTRAINT `correspondance_ibfk_1` FOREIGN KEY (`IdStation`) REFERENCES `station` (`IdStation`),
  CONSTRAINT `correspondance_ibfk_2` FOREIGN KEY (`IdLigne`) REFERENCES `ligne` (`IdLigne`)
...
INSERT INTO `correspondance` VALUES (1,1),(2,2);
...
INSERT INTO `cuisinier` VALUES (1,'cuisine123'),(2,'chef789');
...
INSERT INTO `ingredient` VALUES (1,'Tomates',2.50),(2,'Semoule',1.20);
...
INSERT INTO `ligne` VALUES (1,'Ligne 1'),(2,'Ligne 14');
...
CREATE TABLE `lignedecommande` (
  ...
  KEY `IdPlat` (`IdPlat`),
  CONSTRAINT `lignedecommande_ibfk_1` FOREIGN KEY (`IdCommande`) REFERENCES `commande` (`IdCommande`),
  CONSTRAINT `lignedecommande_ibfk_2` FOREIGN KEY (`IdPlat`) REFERENCES `plat` (`IdPlat`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `lignedecommande` VALUES (1,1,1,2,'2025-03-02','10 rue de Paris'),(2,2,2,1,'2025-03-03','15 avenue de Lyon');
...
CREATE TABLE `listeingredients` (
  ...
  CONSTRAINT `listeingredients_ibfk_1` FOREIGN KEY (`IdRecette`) REFERENCES `recette` (`IdRecette`),
  CONSTRAINT `listeingredients_ibfk_2` FOREIGN KEY (`IdIngredient`) REFERENCES `ingredient` (`IdIngredient`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `listeingredients` VALUES (1,1,3),(2,2,2);
...
CREATE TABLE `livraison` (
  ...
  CONSTRAINT `livraison_ibfk_1` FOREIGN KEY (`IdLigneCommande`) REFERENCES `lignedecommande` (`IdLigneCommande`),
  CONSTRAINT `livraison_ibfk_2` FOREIGN KEY (`IdLivreur`) REFERENCES `utilisateur` (`Id`),
  CONSTRAINT `livraison_ibfk_3` FOREIGN KEY (`IdStationDepart`) REFERENCES `station` (`IdStation`),
  CONSTRAINT `livraison_ibfk_4` FOREIGN KEY (`IdStationArrivee`) REFERENCES `station` (`IdStation`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `livraison` VALUES (1,1,1,1,2,'En attente'),(2,2,2,2,1,'En cours');
...
CREATE TABLE `plat` (
  ...
  CONSTRAINT `plat_ibfk_2` FOREIGN KEY (`IdCuisinier`) REFERENCES `utilisateur` (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `plat` VALUES (1,'Lasagnes',12.50,1,'Plat Principal',2,'2025-03-01','2025-03-03','Végétarien',1,'lasagnes.jpg','Italienne'),(2,'Couscous',15.00,2,'Plat Principal',4,'2025-03-02','2025-03-04','Halal',2,'couscous.jpg','Marocaine');
...
INSERT INTO `recette` VALUES (1,'Ratatouille'),(2,'Tarte aux fraises');
...
INSERT INTO `station` VALUES (1,'Gare de Lyon',40.8632,5.4764),(2,'Châtelet',45.388,3.3489);
...
CREATE TABLE `transaction` (
  ...
  KEY `IdCommande` (`IdCommande`),
  CONSTRAINT `transaction_ibfk_1` FOREIGN KEY (`IdCommande`) REFERENCES `commande` (`IdCommande`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `transaction` VALUES (1,1,25.00,1,'2025-04-02 17:48:12'),(2,2,15.00,1,'2025-04-02 17:48:12');
...
CREATE TABLE `utilisateur` (
  ...
  CONSTRAINT `utilisateur_ibfk_1` FOREIGN KEY (`IdCuisinier`) REFERENCES `cuisinier` (`IdCuisinier`),
  CONSTRAINT `utilisateur_ibfk_2` FOREIGN KEY (`IdClient`) REFERENCES `client` (`IdClient`),
  CONSTRAINT `utilisateur_ibfk_3` FOREIGN KEY (`IdStationProche`) REFERENCES `station` (`IdStation`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `utilisateur` VALUES (1,'Dupond','Jean','10 rue de Paris','0123456789','jean.dupond@email.com',NULL,1,1,0),(2,'Martin','Sofie','15 avenue de Lyon','0987654321','sofie.martin@email.com',1,NULL,2,0);
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2025-04-02 06:55:29',NULL),('diagnostics.include_raw','OFF','2025-04-02 06:55:29',NULL),('ps_thread_trx_info.max_length','65535','2025-04-02 06:55:29',NULL),('statement_performance_analyzer.limit','100','2025-04-02 06:55:29',NULL),('statement_performance_analyzer.view',NULL,'2025-04-02 06:55:29',NULL),('statement_truncate_len','64','2025-04-02 06:55:29',NULL);
...
-- Dump completed on 2025-04-02 17:51:52
